...
WHERE r.msn = c.msn and r.state='ND' and c.sector='transportation sector' and c.type='expenditure' group by c.energy) r1,
(SELECT sum(to_number(r.amount)) sum1 FROM RESOURCES r, Catalog c WHERE r.msn = c.msn and r.state='ND' and c.sector='transportation sector' and c.type='expenditure') total
";
